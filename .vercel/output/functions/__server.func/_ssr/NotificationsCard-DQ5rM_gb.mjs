...
import { a as api, I as Input, B as Button, d as channelFor, e as ConnectedAccountAvatar, r as resolveBackendMediaUrl, c as cn } from "./router-CzJLFPFI.mjs";
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2 space-y-2", children: [
                    links.map((link) => {
                      ...
                      if (mediaKind === "sticker") {
                        return isAnimatedStickerUrl(link) ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-fit rounded-lg border border-border/70 p-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx(TgsSticker, { url: mediaUrl, className: "h-24 w-24" }) }, link) : /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "img",
                          {
                            src: mediaUrl,
                            alt: "Sticker",
                      ...
                      if (mediaKind === "audio") {
                        return /* @__PURE__ */ jsxRuntimeExports.jsx("audio", { src: mediaUrl, controls: true, className: "w-full max-w-md" }, link);
                      }
                      return /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "a",
                        {
